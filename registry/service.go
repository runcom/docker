...
func (s *Service) searchTerm(term string, authConfig *types.AuthConfig, headers map[string][]string, noIndex bool, outs *[]registrytypes.SearchResultExt) error {
...
func (s *Service) Search(term string, authConfig *types.AuthConfig, headers map[string][]string, noIndex bool) ([]registrytypes.SearchResultExt, error) {
	results := []registrytypes.SearchResultExt{}
