...
func Parse(cmd *flag.FlagSet, args []string) (*Config, *HostConfig, *flag.FlagSet, error) {
	...
	hostConfig := &HostConfig{
		...
		Links:           NewList(flLinks.GetAll()),
		PublishAllPorts: *flPublishAll,
		Dns:             NewList(flDns.GetAll()),
		DnsSearch:       NewList(flDnsSearch.GetAll()),
		ExtraHosts:      NewList(flExtraHosts.GetAll()),
		VolumesFrom:     NewList(flVolumesFrom.GetAll()),
		NetworkMode:     netMode,
		IpcMode:         ipcMode,
		PidMode:         pidMode,
		UTSMode:         utsMode,
		Devices:         deviceMappings,
		CapAdd:          NewList(flCapAdd.GetAll()),
		CapDrop:         NewList(flCapDrop.GetAll()),
		RestartPolicy:   restartPolicy,
		SecurityOpt:     NewList(flSecurityOpt.GetAll()),
